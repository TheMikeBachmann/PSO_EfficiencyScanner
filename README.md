...
1. **PSOBB Addon Plugin** — provides the Lua runtime and `pso.*` API this addon depends on. Install from [psobbaddonplugin](https://github.com/Solybum/psobbaddonplugin) + Visual C++ Redistributable 2015.
