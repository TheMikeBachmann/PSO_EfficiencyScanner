...
**Quest name** is read automatically from memory as soon as a quest is loaded — it appears in the idle window while still on Pioneer 2, before the first floor transition.
